      ...
      resl.forEach(element => {
        ...
        // bot.sendMessage(element._id,`ارباح اخر 24 ساعه لتاريخ ${fdate}  \n رصيد البارحه:${ypaid} ETH\n رصيد اليوم: ${prof} ETH \n الربح: ${profit} ETH \n الربح بلدولار: ${usdprof.toFixed(2)} $  \n  سعر الايثيروم حاليا: ${usdprice} $`);
          bot.sendMessage(element._id,
            `ارباح اخر 24 ساعه لتاريخ ${fdate}  \n رصيد البارحه:${ypaid} ETH\n رصيد اليوم: ${prof.toFixed(4)} ETH \n الربح: ${profit} ETH \n الربح بلدولار: ${usdprof.toString().substring(0,6)} $  \n  سعر الايثيروم حاليا: ${usdprice} $`);
...
bot.sendMessage(chatId,
  `الارباح من البارحه لحد الان \n رصيد البارحه:${ypaid} ETH\n  الرصيد الحالي: ${unpaid.toFixed(4)} ETH \n الربح: ${profit} ETH \n الربح بلدولار: ${usdprof.toFixed(2)} $  \n  سعر الايثيروم حاليا: ${usdprice} $`);
